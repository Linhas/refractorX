...
public class EliasWrapper
{
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	#endif
	public delegate void elias_effect_info_get_parameter_descriptive_name(byte parameter_index, StringBuilder name, IntPtr user);
	#if !UNITY_IOS || UNITY_EDITOR
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	#endif
	public delegate void elias_effect_info_get_parameter_value_unit_label(byte parameter_index, StringBuilder unit, IntPtr user);
	#if !UNITY_IOS || UNITY_EDITOR
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	#endif
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	#endif
	public delegate void elias_effect_info_get_int32_option_parameter_descriptive_name(byte parameter_index, int value, StringBuilder name, IntPtr user);
	#if !UNITY_IOS || UNITY_EDITOR
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	#endif
	public delegate void elias_effect_info_get_input_descriptive_name(byte input_index, StringBuilder name, IntPtr user);
	#if !UNITY_IOS || UNITY_EDITOR
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	#endif
	...
	[StructLayout(LayoutKind.Sequential)]
	public struct elias_effect_info
	{
		[MarshalAs(UnmanagedType.ByValTStr, SizeConst=32)]
	...
	private static extern elias_result_codes elias_get_transition_option_info(elias_handle handle, IntPtr filter, uint option_index, string transition_preset, byte find_exact, out uint option_id, out uint option_data_type, StringBuilder theme_name, StringBuilder track_name, out int level, out int variation);
	public static elias_result_codes elias_get_transition_option_info_wrapped(elias_handle handle, elias_source_specifier? filter, uint option_index, string transition_preset, byte find_exact, out uint option_id, out uint option_data_type, out string theme_name, out string track_name, out int level, out int variation)
	{
		...
		StringBuilder theme_name_b = new StringBuilder();
		theme_name_b.Capacity = 64;
		StringBuilder track_name_b = new StringBuilder();
		track_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_transition_option_info(handle, filter_ptr, option_index, transition_preset, find_exact, out option_id, out option_data_type, theme_name_b, track_name_b, out level, out variation);
		if (filter.HasValue)
		{
			Marshal.FreeHGlobal(filter_ptr);
		}
		theme_name = theme_name_b.ToString();
		track_name = track_name_b.ToString();
		return returnValue;
	}
	...
	private static extern elias_result_codes elias_get_transition_preset_name(elias_handle handle, uint transition_preset_index, StringBuilder out_name);
	...
	{
		StringBuilder out_name_b = new StringBuilder();
		out_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_transition_preset_name(handle, transition_preset_index, out_name_b);
		out_name = out_name_b.ToString();
		return returnValue;
	}
	...
	private static extern elias_result_codes elias_get_action_preset_name(elias_handle handle, uint action_preset_index, StringBuilder out_name);
	public static elias_result_codes elias_get_action_preset_name_wrapped(elias_handle handle, uint action_preset_index, out string out_name)
	{
		StringBuilder out_name_b = new StringBuilder();
		out_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_action_preset_name(handle, action_preset_index, out_name_b);
		out_name = out_name_b.ToString();
		return returnValue;
	}
	...
	private static extern elias_result_codes elias_get_action_preset_required_initial_theme(elias_handle handle, string preset_name, StringBuilder theme_name);
	public static elias_result_codes elias_get_action_preset_required_initial_theme_wrapped(elias_handle handle, string preset_name, out string theme_name)
	{
		StringBuilder theme_name_b = new StringBuilder();
		theme_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_action_preset_required_initial_theme(handle, preset_name, theme_name_b);
		theme_name = theme_name_b.ToString();
		return returnValue;
	}
	...
	private static extern elias_result_codes elias_get_theme_name(elias_handle handle, uint theme_index, StringBuilder out_name);
	public static elias_result_codes elias_get_theme_name_wrapped(elias_handle handle, uint theme_index, out string out_name)
	{
		StringBuilder out_name_b = new StringBuilder();
		out_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_theme_name(handle, theme_index, out_name_b);
		out_name = out_name_b.ToString();
		return returnValue;
	}
	...
	private static extern elias_result_codes elias_get_track_name(elias_handle handle, string theme_name, uint track_index, StringBuilder out_name);
	public static elias_result_codes elias_get_track_name_wrapped(elias_handle handle, string theme_name, uint track_index, out string out_name)
	{
		StringBuilder out_name_b = new StringBuilder();
		out_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_track_name(handle, theme_name, track_index, out_name_b);
		out_name = out_name_b.ToString();
		return returnValue;
	}
	...
	private static extern elias_result_codes elias_get_track_group_name(elias_handle handle, uint track_group_index, StringBuilder out_name);
	public static elias_result_codes elias_get_track_group_name_wrapped(elias_handle handle, uint track_group_index, out string out_name)
	{
		StringBuilder out_name_b = new StringBuilder();
		out_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_track_group_name(handle, track_group_index, out_name_b);
		out_name = out_name_b.ToString();
		return returnValue;
	}
	...
	private static extern elias_result_codes elias_get_track_group_theme(elias_handle handle, string group_name, StringBuilder theme_name);
	public static elias_result_codes elias_get_track_group_theme_wrapped(elias_handle handle, string group_name, out string theme_name)
	{
		StringBuilder theme_name_b = new StringBuilder();
		theme_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_track_group_theme(handle, group_name, theme_name_b);
		theme_name = theme_name_b.ToString();
		return returnValue;
	}
	...
	private static extern elias_result_codes elias_get_track_in_track_group(elias_handle handle, string group_name, uint track_index, StringBuilder track_name);
	public static elias_result_codes elias_get_track_in_track_group_wrapped(elias_handle handle, string group_name, uint track_index, out string track_name)
	{
		StringBuilder track_name_b = new StringBuilder();
		track_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_track_in_track_group(handle, group_name, track_index, track_name_b);
		track_name = track_name_b.ToString();
		return returnValue;
	}
	...
	public static extern elias_result_codes elias_get_effect_info(elias_handle handle, uint effect_index, out elias_effect_info info);

	[DllImport(DllName, CallingConvention=CallingConvention.Cdecl, EntryPoint="elias_get_effect_info_by_name")]
	public static extern elias_result_codes elias_get_effect_info_by_name(elias_handle handle, string effect_name, out elias_effect_info info);
	...
	public static extern elias_result_codes elias_get_event_in_action_preset(elias_handle handle, string preset_name, uint event_index, out elias_event @event);
	...
	public static extern elias_result_codes elias_get_event(elias_handle handle, uint event_index, out elias_event @event);
	...
	private static extern elias_result_codes elias_get_bus_name(elias_handle handle, uint bus_index, StringBuilder out_name);
	public static elias_result_codes elias_get_bus_name_wrapped(elias_handle handle, uint bus_index, out string out_name)
	{
		StringBuilder out_name_b = new StringBuilder();
		out_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_bus_name(handle, bus_index, out_name_b);
		out_name = out_name_b.ToString();
		return returnValue;
	}
	...
	private static extern elias_result_codes elias_get_send_destination_bus_info(elias_handle handle, string bus_name, byte slot, StringBuilder out_name, out byte destination_slot);
	public static elias_result_codes elias_get_send_destination_bus_info_wrapped(elias_handle handle, string bus_name, byte slot, out string out_name, out byte destination_slot)
	{
		StringBuilder out_name_b = new StringBuilder();
		out_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_send_destination_bus_info(handle, bus_name, slot, out_name_b, out destination_slot);
		out_name = out_name_b.ToString();
		return returnValue;
	}

	[DllImport(DllName, CallingConvention=CallingConvention.Cdecl, EntryPoint="elias_get_send_destination_effect_info")]
	private static extern elias_result_codes elias_get_send_destination_effect_info(elias_handle handle, string bus_name, byte slot, StringBuilder out_effect_name, out byte destination_effect_input_index);
	...
	{
		StringBuilder out_effect_name_b = new StringBuilder();
		out_effect_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_send_destination_effect_info(handle, bus_name, slot, out_effect_name_b, out destination_effect_input_index);
		out_effect_name = out_effect_name_b.ToString();
		return returnValue;
	}

	[DllImport(DllName, CallingConvention=CallingConvention.Cdecl, EntryPoint="elias_get_effect_name")]
	private static extern elias_result_codes elias_get_effect_name(elias_handle handle, string bus_name, byte slot, StringBuilder out_effect_name);
	public static elias_result_codes elias_get_effect_name_wrapped(elias_handle handle, string bus_name, byte slot, out string out_effect_name)
	{
		StringBuilder out_effect_name_b = new StringBuilder();
		out_effect_name_b.Capacity = 64;
		elias_result_codes returnValue = elias_get_effect_name(handle, bus_name, slot, out_effect_name_b);
		out_effect_name = out_effect_name_b.ToString();
		return returnValue;
	}
